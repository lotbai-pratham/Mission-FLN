...
export const SIMS: Item[] = [
  { 
    ...
    accentColor: "emerald", component: (p) => <LetterFlash {...p} /> 
  },
  { 
    ...
    accentColor: "blue", component: (p) => <WordRace {...p} /> 
  },
  { 
    ...
    accentColor: "violet", component: (p) => <SentenceFill {...p} /> 
  },
  { 
    ...
    accentColor: "orange", component: (p) => <MathDuel {...p} /> 
  },
  { 
    ...
    accentColor: "amber", component: (p) => <NumberRace {...p} /> 
  },
  { 
    ...
    accentColor: "blue", component: (p) => <PlaceValueBattle {...p} /> 
  },
  { 
    ...
    accentColor: "rose", component: (p) => <MathSprint {...p} /> 
  },
  { 
    ...
    accentColor: "violet", component: (p) => <SoundDuel {...p} /> 
  },
  { 
    ...
    accentColor: "emerald", component: (p) => <NumberHunter {...p} /> 
  },
  { 
    ...
    accentColor: "orange", component: (p) => <BundleBuilder {...p} /> 
  },
  { 
    ...
    accentColor: "blue", component: (p) => <AdditionMaster {...p} /> 
  },
  { 
    ...
    accentColor: "amber", component: (p) => <SoundExplorer {...p} /> 
  },
  { 
    ...
    accentColor: "emerald", component: (p) => <WordBuilder {...p} /> 
  },
  { 
    ...
    accentColor: "violet", component: (p) => <SentenceArchitect {...p} /> 
  },
  { 
    ...
    accentColor: "orange", component: (p) => <Chaudakhadi {...p} /> 
  },
  { 
    ...
    accentColor: "blue", component: (p) => <StoryReader {...p} /> 
  },
  { 
    ...
    accentColor: "rose", component: (p) => <NumberLine {...p} /> 
  },
  { 
    ...
    accentColor: "amber", component: (p) => <MathManiaMarket {...p} /> 
  },
  { 
    ...
    accentColor: "emerald", component: (p) => <VachanPravas {...p} /> 
  },
  { 
    ...
    accentColor: "rose", component: (p) => <AksharCrush {...p} /> 
  },
  { 
    ...
    accentColor: "violet", component: (p) => <MatraChakra {...p} /> 
  },
  { 
    ...
    accentColor: "emerald", component: (p) => <GyanSidi {...p} /> 
  },
  { 
    id: "fraction-viz", title: "🍰 Fractions Explorer", level: "Operations", battleLevel: 4, subject: "Math", emoji: "🍰", 
    instructions: ["अपूर्णांक (Fractions) समजून घ्या.", "केक किंवा पिझ्झाचे भाग करा.", "अंशा आणि छेद यांची ओळख पक्की करा.", "वेगवेगळे भाग जोडून पूर्ण वस्तू बनवा.", "अपूर्णांकांच्या जगात मजा करा!"], 
    accentColor: "rose", component: (p) => <FractionViz {...p} /> 
  },
  { 
    ...
    accentColor: "blue", component: (p) => <DigitalAbacus {...p} /> 
  },
  { 
    ...
    accentColor: "orange", component: (p) => <DivisionSim {...p} /> 
  },
  { 
    ...
    accentColor: "emerald", component: (p) => <EqualSharing {...p} /> 
  },
  { 
    ...
    accentColor: "violet", component: (p) => <MultiplicationSim {...p} /> 
  },
  { 
    ...
    accentColor: "blue", component: (p) => <RepeatedAddition {...p} /> 
  },
  { 
    ...
    accentColor: "amber", component: (p) => <SankhyaChakra {...p} /> 
  },
  { 
    ...
    accentColor: "emerald", component: (p) => <TiliBundleDuel {...p} /> 
  },
];
...
export const GAMES: Item[] = [
  { 
    ...
    accentColor: "amber", component: (p) => <OddOneOut {...p} /> 
  },
  { 
    ...
    accentColor: "emerald", component: (p) => <LetterPicker {...p} /> 
  },
  { 
    ...
    accentColor: "blue", component: (p) => <MissingLetter {...p} /> 
  },
  { 
    ...
    accentColor: "blue", component: (p) => <FishGame {...p} /> 
  },
  { 
    ...
    accentColor: "rose", component: (p) => <RhymeTime {...p} /> 
  },
  { 
    ...
    accentColor: "violet", component: (p) => <SentenceBuilder {...p} /> 
  },
  { 
  ...
  { 
    ...
    accentColor: "blue", component: (p) => <BiggerSmaller {...p} /> 
  },
  { 
  ...
  { 
    ...
    accentColor: "blue", component: (p) => <NumberBonds {...p} /> 
  },
  { 
    ...
    accentColor: "amber", component: (p) => <MarketMath {...p} /> 
  },
  { 
    ...
    accentColor: "blue", component: (p) => <NumberRiver {...p} /> 
  },
  { 
    ...
    accentColor: "rose", component: (p) => <ClockReader {...p} /> 
  },
  { 
    ...
    accentColor: "violet", component: (p) => <SortingHat {...p} /> 
  },
  { 
    ...
    accentColor: "orange", component: (p) => <MatraPractice {...p} /> 
  },
  { 
    ...
    accentColor: "emerald", component: (p) => <JungleFight {...p} /> 
  },
  { 
    ...
    accentColor: "rose", component: (p) => <EmpathyHero {...p} /> 
  },
  { 
    ...
    accentColor: "blue", component: (p) => <BuddyBigDay {...p} /> 
  },
  { 
    ...
    accentColor: "emerald", component: (p) => <GermBuster {...p} /> 
  },
  { 
    ...
    accentColor: "amber", component: (p) => <HealthyPlate {...p} /> 
  },
  { 
    ...
    accentColor: "orange", component: (p) => <DailyRoutine {...p} /> 
  },
  { 
    ...
    accentColor: "emerald", component: (p) => <WasteSort {...p} /> 
  },
];
