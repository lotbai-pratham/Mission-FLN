...
export default function WasteSort({ onClose }: { onClose?: () => void }) {
  ...
  return (
    <div className="relative w-full md:min-h-[648px] min-h-[450px] bg-gradient-to-br from-orange-50 to-amber-50 rounded-[40px] overflow-visible border-4 md:border-8 border-white shadow-2xl flex flex-col font-sans">
      {/* Header */}
